...
class OptionsOrder(Tradier):
    ...
    def options_order(self, occ_symbol, order_type, side, quantity, underlying=False, limit_price=False,
                      stop_price=False, duration='day'):
        """
        Params:
        ...
        Example:
            ...
            >>> options_order.options_order(occ_symbol='LMT240119C00260000', order_type='market',
            >>>                             side='sell_to_close', quantity=10.0)
